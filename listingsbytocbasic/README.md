...
KOMA presents the `listingsbytocbasic` package to extend the functionality 
of package [`listings`](https://ctan.org/pkg/listings). The 
`listingsbytocbasic` package is part of the *third-party enhancements*
project.
...
`listingsbytocbasic` is such an enhancement package. It provides additional
